#define NGX_CONFIGURE " --prefix=/usr/local/openresty/nginx --with-cc-opt=-O2 --add-module=../ngx_devel_kit-0.2.19 --add-module=../echo-nginx-module-0.58 --add-module=../xss-nginx-module-0.05 --add-module=../ngx_coolkit-0.2rc3 --add-module=../set-misc-nginx-module-0.30 --add-module=../form-input-nginx-module-0.11 --add-module=../encrypted-session-nginx-module-0.04 --add-module=../srcache-nginx-module-0.30 --add-module=../ngx_lua-0.10.2 --add-module=../ngx_lua_upstream-0.05 --add-module=../headers-more-nginx-module-0.29 --add-module=../array-var-nginx-module-0.05 --add-module=../memc-nginx-module-0.16 --add-module=../redis2-nginx-module-0.12 --add-module=../redis-nginx-module-0.3.7 --add-module=../rds-json-nginx-module-0.14 --add-module=../rds-csv-nginx-module-0.07 --with-ld-opt=-Wl,-rpath,/data/app/nginx/luajit/lib --with-stream --with-pcre=/data/chandler/pcre-8.38 --with-openssl=/data/chandler/openssl-1.0.1e --add-module=/data/chandler/nb_openresty/bundle/stream-lua-nginx-module-0.0.1 --error-log-path=log/error.log --http-log-path=log/access.log --pid-path=log/nginx.pid --lock-path=log/nginx.lock --with-http_ssl_module"

#ifndef NGX_COMPILER
#define NGX_COMPILER  "gcc 4.4.6 20110731 (Red Hat 4.4.6-4) (GCC) "
#endif
...
#ifndef NGX_PID_PATH
#define NGX_PID_PATH  "log/nginx.pid"
#endif


#ifndef NGX_LOCK_PATH
#define NGX_LOCK_PATH  "log/nginx.lock"
#endif


#ifndef NGX_ERROR_LOG_PATH
#define NGX_ERROR_LOG_PATH  "log/error.log"
#endif


#ifndef NGX_HTTP_LOG_PATH
#define NGX_HTTP_LOG_PATH  "log/access.log"
#endif
